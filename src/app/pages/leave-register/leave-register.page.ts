...
@Component({
  ...
  templateUrl: './leave-register.page.html',
  styleUrls: ['./leave-register.page.scss'],
})
export class LeaveRegisterPage implements OnInit {
  tabs: string;
  loginData: any;
  empData: any;
  employee_data: any;
  ...
  GetApproveRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetLeaveApproveRegisterListFromMobile", postData)
      .subscribe(response => {
  ...
  GetRejectRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetLeaveRejectRegisterListFromMobile", postData)
      .subscribe(response => {
  ...
  GetPendingRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetLeavePendingRegisterListFromMobile", postData)
      .subscribe(response => {
