...
@Component({
  selector: 'app-regularization-register',
  templateUrl: './regularization-register.page.html',
  styleUrls: ['./regularization-register.page.scss'],
})
export class RegularizationRegisterPage implements OnInit {
  ...
  GetApproveRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetRegularizationApproveRegisterListFromMobile", postData)
      .subscribe(response => {
        ...
        if (response['error_code'] == '0') {
            ...
            this.employee_data = response['data']['regularize_data'];   
  ...
  GetRejectRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetRegularizationRejectRegisterListFromMobile", postData)
      .subscribe(response => {
  ...
  GetPendingRegister() {
    ...
    this.http.post(this.appCommon.baseAppUrl + "GetRegularizationPendingRegisterListFromMobile", postData)
      .subscribe(response => {
